...
<jcr:root xmlns:sling="http://sling.apache.org/jcr/sling/1.0" xmlns:jcr="http://www.jcp.org/jcr/1.0" xmlns:nt="http://www.jcp.org/jcr/nt/1.0"
            ...
            jcr:description="${name} notnaked component library"
>
    <jcr:content
        jcr:primaryType="per:PageContent"
        sling:resourceType="notnaked/components/page"
        jcr:title="${name}"
        description="${name} notnaked component library"
        brand="notnaked"
        template="/content/templates/notnaked"
            ><clheader
            jcr:primaryType="nt:unstructured" sling:resourceType="notnaked/components/header" htmlelement="header" backgroundtype="color" bgcolor="#eeeeee" colorscheme="light" toppadding="10" bottompadding="10" bgvideo="https://www.youtube.com/embed/Ju86mknumYM" collapsed="false" logo="/content/assets/notnaked/samples/peregrine-logo.svg" logoalttext="Peregrine CMS Logo" logourl="/content/sites/notnaked/library.html" logosize="60" buttonsize="default"><elevation jcr:primaryType="nt:unstructured"></elevation>
    ...
    footer() {
        return `
        <clfooter
        jcr:primaryType="nt:unstructured" sling:resourceType="notnaked/components/footer" htmlelement="footer" backgroundtype="color" bgcolor="#eeeeee" bottompadding="0" toppadding="30" colorscheme="light" showlogo="true" logo="/content/assets/notnaked/samples/peregrine-logo.svg" logourl="/content/sites/notnaked/library.html" logoalttext="Peregrine CMS Logo" logosize="60" copyright="Copyright 2019 Peregrine - All Rights Reserved">
...
return `<title${idx} jcr:primaryType="nt:unstructured" 
    sling:resourceType="notnaked/components/richtext" 
...
${children.map((child => `<li><a href="${path}${child}.html">${child}</a></li>`)).join('')}
    ...
    home() {
        ...
        bgcolor="#eeeeee"
        htmlelement="nav"
        jcr:primaryType="nt:unstructured" sling:resourceType="notnaked/components/breadcrumb" level="2"><toppadding jcr:primaryType="nt:unstructured"></toppadding>
        <bottompadding jcr:primaryType="nt:unstructured"></bottompadding>
        </clbreadcrumb>`;
        // return this.text('<p><a href="/content/sites/notnaked/library.html">component library home</a></p>');
    },
    ...
    pager() {
        ...
        prevlabel="&lt; previous"
        nextlabel="next &gt;"
        jcr:primaryType="nt:unstructured" sling:resourceType="notnaked/components/pager">
        </pager${idx++}>`;
        // return this.text('<p><a href="/content/sites/notnaked/library.html">component library home</a></p>');
    },
    ...
    container(el, content) {
        return `<container${idx}
            jcr:primaryType="nt:unstructured"
            sling:resourceType="notnaked/components/container"
            htmlelement="${el}">
            ${content}
        </container${idx++}>`
    },
    ...
    cards(cards) {
        ...
        `<cards${cardNum}
            jcr:primaryType="nt:unstructured"
            sling:resourceType="notnaked/components/cards"
