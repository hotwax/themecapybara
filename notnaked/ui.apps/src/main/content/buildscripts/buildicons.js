...
var iconPath = basePath + '/content/assets/notnaked/icons';
...
glob.glob('**/*.svg', { cwd: iconPath }, function (err, files) {
    ...
    spriter.compile(function (error, result, data) {
      fs.writeFileSync(basePath + '/apps/notnaked/components/page/iconsprites.html', result.symbol.sprite.contents);
    });
});
