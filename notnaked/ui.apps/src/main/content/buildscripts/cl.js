...
function outSample(name, sample, variation=null) {
    ...
    const attrs = [['jcr:primaryType', 'nt:unstructured'], ['sling:resourceType','notnaked/components/'+name]];
    const children = [];
...
function forEachComponent(target = 'src/main/content/jcr_root/content/sites/notnaked/library', root = '../fragments/') {
    const pages = [];
