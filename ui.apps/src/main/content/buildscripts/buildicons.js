...
var iconPath = basePath + '/content/assets/themecapybara/icons';
...
glob.glob('**/*.svg', { cwd: iconPath }, function (err, files) {
    ...
    spriter.compile(function (error, result, data) {
      fs.writeFileSync(basePath + '/apps/themecapybara/components/page/iconsprites.html', result.symbol.sprite.contents);
    });
});
